...
client.on('message', message =>{
  ...
  client.on('message', message => {    
    ...
    if(message.author.id === "190057608839823369" ||
message.author.id === "190057608839823369"){
       let args = message.content.split(" ").slice(1);         
...
client.on('message', msg => {
    if (msg.content === '.invite') {
      msg.channel.send('Invite **Lightt Community** https://discordapp.com/oauth2/authorize?client_id=457433736292597790&permissions=8&scope=bot  :tada:');
    }
  });

client.on('message', msg => {
    if (msg.content === '.support') {
      msg.channel.send('support server ---> https://discord.gg/BBSWBEj');
    }
  });
